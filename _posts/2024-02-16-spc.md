...
![https://www.statisticshowto.com/statistical-process-control/](spc_example.png)
<p class="caption">
Example of using SPC to monitor the mean of a single variable (see https://www.statisticshowto.com/statistical-process-control/).
</p>
